...
function run(TrainLine, StartStation, EndStation,ArrivalTime,DayofWeek) {
...
app.post('/commuterequest',async function(request,response){
    ...
    const outputjson =await run(request.body.TrainLine,request.body.StartStation, request.body.EndStation, request.body.ArrivalTime,request.body.DayofWeek);
